# -*- coding: utf-8 -*-
"""Fine-Tuning LLMs with Lama2 - Partial Code

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/174S4fRx2-4fPkofrO2sdyDzYOaG8mQFj
...
SFT_Trainer = SFTTrainer(model = llama_model,
...
text_generation_pipeline = pipeline(task = "text-generation",
                                   model = llama_model,
                                   tokenizer = llama_tokenizer, max_length = 300)
